...
function App() {
      ...
      <div className="grid grid-cols-5 h-screen text-center">
        ...
        <div className="col-span-4 p-10">
          <h1 className="text-4xl bg-clip-text text-transparent bg-gradient-to-r from-green-700 to-violet-700">
            GENZIAI, SOLUTION TO YOUR PROBLEMS
          </h1>
  ...
  [&::-webkit-scrollbar]:hidden  "
          ...
          <div
            className="dark:bg-zinc-900 bg-white bg-red-100 w-1/2 dark:text-white text-zinc-800 m-auto rounded-4xl border-2 border-purple-400/40
